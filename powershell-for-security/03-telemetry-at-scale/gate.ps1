...
# Runs entirely on Linux pwsh: no Get-WinEvent (Windows-only), events come from the pre-exported
# data/events.jsonl artifact.

$ErrorActionPreference = 'Stop'

Write-Output '=== PSScriptAnalyzer: ./Vigil (the reference module) ==='
