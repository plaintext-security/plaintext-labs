...
- [NVD — CVE-2014-0160 (Heartbleed)](https://nvd.nist.gov/vuln/detail/CVE-2014-0160) and [CVE-2017-15361 (ROCA)](https://nvd.nist.gov/vuln/detail/CVE-2017-15361) — read both descriptions side by side as a model for how a *named break* becomes an *audit check*: Heartbleed → "is OpenSSL patched / does testssl.sh flag it?", ROCA → "was this RSA key generated by a sound library?". Each finding line in your report should trace to a failure this concrete.
