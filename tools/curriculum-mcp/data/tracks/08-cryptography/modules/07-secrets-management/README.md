...
**Secrets management's real-world failure — the *why* (~15 min)**
- [breaches.cloud — Uber 2014 & 2016 incidents](https://www.breaches.cloud/incidents/uber/) — the 2016 breach: AWS access keys hardcoded in a private GitHub repo unlocked an S3 bucket with 57M users' data. Read it for the chain of failures — static keys, broad scope, secret-in-source — that Vault dynamic secrets and access policies exist to break.
