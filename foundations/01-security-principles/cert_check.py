...
def main() -> int:
    ...
    try:
        not_after = fetch_not_after_over_tls(args.host)
        ...
        print(f"No network / could not reach {args.host}: {exc}")
        ...
        print(f"Could not check {args.host}: {exc}")
        return 1

    return report(args.host, not_after, args.warn)
